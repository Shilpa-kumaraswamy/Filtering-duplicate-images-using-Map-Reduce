...
public class FamilyFilterExample { 
 ...
 conf.set("hbase.zookeeper.quorum","ip-20-0-31-4.ec2.internal");      
 ...
 public static String padNum(int num, int pad) { 
  ...
  public static void main(String[] args) throws IOException { 
    ...
    conf.set("hbase.zookeeper.quorum","ip-20-0-31-4.ec2.internal");           
    conf.set("hbase.zookeeper.property.clientPort","2181");    
    FamilyFilterExample.dropTable("puttesttable"); 
    FamilyFilterExample.createTable("puttesttable", "colfam1", "colfam2", "colfam3", "colfam4"); 
    System.out.println("Adding rows to table..."); 
    FamilyFilterExample.fillTable("testtable", 1, 10, 2, -1,false,false,"colfam1", "colfam2", "colfam3", "colfam4"); 
 
    HTable table = new HTable(conf, "puttesttable"); 
